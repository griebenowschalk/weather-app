...
description: >-
  ...
  and the RxJS/Runes state split. Use when adding routes, writing load functions,
  deciding where state should live, or working on +page.svelte, +layout.svelte, server
  vs client rendering.
---
## Routing
