...
description: >-
  ...
  or debugging service files in src/lib/serv/.
when_to_use: >-
  Writing service files, creating Observables, subscribing to streams, debugging memory
  leaks or stale data, or wiring a Rune state class to a service.
