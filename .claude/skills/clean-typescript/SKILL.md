...
description: >-
  ...
  organisation, file naming, and ESLint conventions. Apply when writing or reviewing TS.
when_to_use: >-
  Writing new TypeScript, reviewing types, hitting type errors, or naming new files.
